  ...
  return (
    <div className={s.shell}>
      <div className={s.card}>
        ...
        <h1 className={s.heading}>Créer un compte</h1>
        <p className={s.sub}>Rejoignez Filepilot en quelques secondes</p>
        ...
        <form onSubmit={handleSubmit} className={s.form}>
          ...
          <div className={s.field}>
            ...
            <input id="password" className={s.input} type="password" placeholder="6 caractères minimum" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={6} autoComplete="new-password" />
          </div>
        ...
        <p className={s.footer}>
          Déjà un compte ?{" "}
          <Link href="/login" className={s.footerLink}>Se connecter</Link>
        </p>
      </div>
